...
& "C:\Program Files (x86)\UiPath\Studio\UiRobot.exe" -pack "$env:WORKSPACE\project.json" --output "$env:JENKINS_HOME\jobs\COE\jobs\$env:JOB_NAME\builds\$env:BUILD_NUMBER" -v $project.projectVersion
