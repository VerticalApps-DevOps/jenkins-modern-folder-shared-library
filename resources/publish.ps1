try{   
    ...
    Invoke-RestMethod -SkipCertificateCheck -Body $MultipartContent "https://ec2-52-91-158-128.compute-1.amazonaws.com/odata/Processes/UiPath.Server.Configuration.OData.UploadPackage" -Method Post -Authentication Bearer -Token ($env:token)
